...
- **Failure / edge**
  ...
  - `draft`/`withdrawn` → the dialog renders **history only**; Change status is hidden, since the override path is `reviewable`-scoped and would throw.
