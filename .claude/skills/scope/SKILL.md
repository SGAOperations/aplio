...
Read `docs/ENGINEERING.md` and the relevant parts of the codebase as needed so the decomposition reflects how this app is actually built (server components, server actions in `prisma/actions/`, queries in `prisma/data/`, etc.).
