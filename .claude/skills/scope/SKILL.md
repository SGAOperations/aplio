...
Read `ENGINEERING.md` and the relevant parts of the codebase as needed so the decomposition reflects how this app is actually built (server components, services in `prisma/services/`, etc.).
